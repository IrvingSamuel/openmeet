...
type BrandPanelProps = {
  /** Room brand editor ù when set, defaults APIs to `/api/rooms/{slug}/brand`. */
  slug?: string;
  brandUrl?: string;
  uploadUrl?: string;
          ...
          {tab === "palette" ? (
            <>
              ...
              <AssetUrlField
                ...
                uploadUrl={resolvedUploadUrl}
                kind="pattern"
                placeholder="https://ù/pattern.png"
              />
          ...
          {tab === "advanced" ? (
            <>
              ...
              <Input
                ...
                placeholder="https://ù/favicon.png"
              />
              <Textarea
